...
public class ImportCommand extends CommandBase {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
		...
		sender.sendMessage(new TextComponentString("Finished importing the achievement book."));
		sender.sendMessage(new TextComponentString("New book file created in config/achievementbooks/imported_achievement_book.json"));
		sender.sendMessage(new TextComponentString("It's not going to be perfect, but gets the most of the job done."));
